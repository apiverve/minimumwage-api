...
```gradle
dependencies {
    implementation 'com.github.apiverve:minimumwage-api:1.1.13'
}
```
...
```java
import com.apiverve.minimumwage.MinimumWageAPIClient;
import com.apiverve.minimumwage.APIResponse;
import com.apiverve.minimumwage.APIException;

// Initialize the client
MinimumWageAPIClient client = new MinimumWageAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/minimumwage](https://docs.apiverve.com/ref/minimumwage)
...
- **Documentation:** [https://docs.apiverve.com/ref/minimumwage](https://docs.apiverve.com/ref/minimumwage)
- **Issues:** [GitHub Issues](https://github.com/apiverve/minimumwage-api/issues)
