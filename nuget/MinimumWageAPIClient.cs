...
namespace APIVerve.API.MinimumWage
{
    ...
    /// <summary>
    /// Client for the MinimumWage API
    /// </summary>
...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/minimumwage";
        ...
        public MinimumWageAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MinimumWageAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MinimumWageAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MinimumWageQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MinimumWageQueryOptions options)
        {
        ...
        public ResponseObj Execute(MinimumWageQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MinimumWageQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MinimumWageQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MinimumWageQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MinimumWageQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MinimumWageQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MinimumWageQueryOptions options)
        {
