...
const (
	baseURL        = "https://api.apiverve.com/v1/minimumwage"
	defaultTimeout = 30 * time.Second
)

// Client is the Minimum Wage API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Minimum Wage API client.
...
// Execute makes a request to the Minimum Wage API with typed parameters.
//
