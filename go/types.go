// Package minimumwage provides a Go client for the Minimum Wage API.
//
// For more information, visit: https://apiverve.com/marketplace/minimumwage?utm_source=go&utm_medium=readme
package minimumwage
...
// Request contains the parameters for the Minimum Wage API.
//
// Parameters:
//   - state: string - Optional 2-letter state code (e.g., CA, NY). Omit for all states. [minLength: 2, maxLength: 2]
type Request struct {
...
// ResponseData contains the data returned by the Minimum Wage API.
type ResponseData struct {
	State string `json:"state"`
	StateName string `json:"stateName"`
	MinimumWage int `json:"minimumWage"`
	StateRate int `json:"stateRate"`
	FederalRate float64 `json:"federalRate"`
	TippedMinimum int `json:"tippedMinimum"`
	UsesFederalRate bool `json:"usesFederalRate"`
